...
public class HomeWork4 {
    ...
    public static void toStack(Character [] arr) {
        List<Character> linLst = new LinkedList<>(Arrays.asList(arr));
        for (int i = 0; i < linLst.size(); i++) {
            System.out.print(linLst.get(i));
        } 
    }   
}
